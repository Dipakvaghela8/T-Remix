...
#        Author: Vaghela Dipak          #

#  email: vdipakj@gmail.com   #

######################################

echo -e "\e[32m[*]\e[34m WELCOME TO Vaghela Dipak TOOLS  \e[m "
...
echo "
        ...
        WELCOME TO Vaghela Dipak TOOLS_-^^MR.DIPAK^^-_ SUBSCRIBE YOUTUBE CHANNEL
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY VAGHELA DIPAK\e[m "

echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"

echo -e "\033[1;33m[*]Please SUBSCRIBE MR.DIPAK channel for hacking tutorial! \e[m "
...
echo -e "\e[32m     
    ...
    SUBSCRIBE MR.DIPAK channel for hacking and cyber security tutorials,ok?
...
echo -e "\x1b[42m VAGHELA DIPAK's MR.DIPAKchannel \x1b[m"
...
figlet -f slant "VAGHELA DIPAK's MR.VAGHELA" |lolcat
